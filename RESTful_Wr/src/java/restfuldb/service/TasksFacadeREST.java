 ...
 */
@javax.ejb.Stateless
@javax.ws.rs.Path("restfuldb.tasks")
public class TasksFacadeREST extends AbstractFacade<Tasks> {
    ...
    @javax.ws.rs.Path("{id}")
    @javax.ws.rs.Consumes({javax.ws.rs.core.MediaType.APPLICATION_XML, javax.ws.rs.core.MediaType.APPLICATION_JSON})
    public void edit(@javax.ws.rs.PathParam("id") String id, Tasks entity) {
        super.edit(entity);
    }
    ...
    public Tasks find(@javax.ws.rs.PathParam("id") String id) {
    ...
    @javax.ws.rs.Produces({javax.ws.rs.core.MediaType.APPLICATION_XML, javax.ws.rs.core.MediaType.APPLICATION_JSON})
    public List<Tasks> findRange(@javax.ws.rs.PathParam("from") Integer from, @javax.ws.rs.PathParam("to") Integer to) {
